...
public class DownloadResourceActivity extends Activity implements
        PostAdapter.PostsAdapterListener,
        SwipeRefreshLayout.OnRefreshListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // if (storyListToken == "") storyListToken = "41";
      ...
      //  System.out.println( ">>>>>>>>>>>>>>>>>>"+Utility.pregnant_name );
    ...
    //    System.out.println( ">>>>>>>>>>>>>>>>>>"+Utility.non_pregnant_name );
...
//        unregisterReceiver();
    ...
    private void loadStoryResources() {
        ...
        try {
              ...
              /*ApiInterface apiService = ApiClient.getClient().create(ApiInterface.class);
              Gson gson = new Gson();
              String Json = new String(Utility.getResourcesFromSD(dummy_storyId+".xml"));
              StoryXML storyXML = gson.fromJson(Json, StoryXML.class);*/
        ...
        if(!isRes){
            ...
            hideDialog();
//            startActivity(new Intent(DownloadResourceActivity.this, StoryViewActivity.class));
